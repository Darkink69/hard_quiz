...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description: "Кто композитор фильма?",
    icon: "movie.png",
    color: "yellow-500",
    file: "25.json",
    difficulty: 2,
  ...
  },
  {
    id: "rap",
    name: "Суровый Рэп",
    description: "Не грози южному централу!",
    icon: "rap.png",
    color: "fuchsia-500",
    file: "445.json",
    difficulty: 2,
  },
  {
    id: "brit",
    name: "Бритпоп",
    description: "Роко-попс из Туманного Альбиона",
    icon: "brit.png",
    color: "teal-500",
    file: "206.json",
    difficulty: 2,
  },
  {
    id: "rock2",
    name: "Западный Рок",
    description: "«Грянем рок в этой дыре!..»",
    icon: "rock2.png",
    color: "indigo-500",
    file: "69.json",
    difficulty: 2,
  },
  {
    id: "rave",
    name: "Rave",
    description: "Электронное безумие 90-х",
    icon: "rave.png",
    color: "yellow-500",
    file: "151.json",
    difficulty: 3,
  },
  {
    id: "jazz",
    name: "Классика Джаза",
    description: "«Сегодня ты играешь джаз...»",
    icon: "jazz.png",
    color: "green-500",
    file: "85.json",
    difficulty: 3,
  ...
  {
    id: "narod",
    name: "Русские народны песни",
    description: "Наши песни уходящие в глубь веков",
    icon: "narod.png",
    color: "purple-500",
    file: "40.json",
    difficulty: 2,
  ...
  {
    id: "series",
    name: "Музыка из сериалов",
    description: "Что за песня звучала в этой серии?",
    icon: "TV.png",
    color: "teal-500",
    file: "308.json",
    difficulty: 2,
